...
import com.android.banner.indicator.Indicator;
...
import static com.android.banner.BannerConstants.DEFAULT_AUTO_TIME;
import static com.android.banner.BannerConstants.DEFAULT_PAGER_DURATION;
import static com.android.banner.BannerConstants.NORMAL_COUNT;
...
public class Banner extends FrameLayout {
    ...
    private void initViews(final Context context) {
        ...
        viewPager2.setLayoutParams(new ViewGroup.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT, RelativeLayout.LayoutParams.MATCH_PARENT));
        ...
        registerAdapter(new BannerAdapter());
...
//            viewPager2.setAdapter(mBannerAdapter);
//        } else {
...
//        }
    ...
    private int getRealCount() {
        return mBannerAdapter.getRealCount();
    }
    ...
    void registerAdapter(BannerAdapter adapter) {
        if (this.mBannerAdapter != null) {
            this.mBannerAdapter.unregisterAdapterDataObserver(itemDataSetChangeObserver);
        }
        this.mBannerAdapter = adapter;
        if (this.mBannerAdapter != null) {
            this.mBannerAdapter.registerAdapterDataObserver(itemDataSetChangeObserver);
        }
    ...
    public void setImageLoader(ImageLoader imageLoader) {
        getAdapter().setImageLoader(imageLoader);
    }
    ...
    public void setData(List dataList) {
        ...
        getViewPager2().setOffscreenPageLimit(dataList.size() + NORMAL_COUNT);
